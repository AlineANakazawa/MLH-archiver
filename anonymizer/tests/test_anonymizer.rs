...
#[cfg(test)]
mod tests {
    use anonymizer::anonymizer::anonymize_string;
    ...
    fn test_correct_email() {
        let string_test_cases = [
            ...
            // multi line string
            (
                r#"From: Kathryn Janeway <kathryn.janeway@starfleet.local>
        ...
        Signed-off-by: Alyssa Ogawa <alyssa.ogawa@starfleet.local>"#,
                r#"From: 567f342ca3222a3c95bdfd21e2861e6b25b1cc9e <d01486ee33b2283893efd9ed8d48fb6215701542>
        ...
        Signed-off-by: b1f386047221c342010c24fb02cdf3855f38ad46 <1098a4204bd8e6f3f4a48fdf24f9a94765f10786>"#,
            ...
            ("user(a)domain.com", "user(a)domain.com"),
            ...
            ("@@ -10,7 +10,6 @@", "@@ -10,7 +10,6 @@"),
            ("2.20.1.7.g153144c", "2.20.1.7.g153144c"),
            (
        ...
        for (input_string, expected) in string_test_cases.iter() {
            let result = anonymize_string(input_string);
            assert_eq!(
                result.as_str(),
                *expected,
                "Anonymized strings should match for input:\n{}",
                input_string
            );
        }
    }
